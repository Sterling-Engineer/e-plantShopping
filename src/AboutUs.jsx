  ...
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">
        Welcome to Lilly & Rose Nursery, where green meets serenity!
      </p>

      <p className="about-us-content">
        At Lilly & Rose Nursery, we are passionate about bringing nature closer to you.
      ...
      <p className="about-us-content">
        ...
        Feel free to explore our collection, ask questions, and let us help you find the
      ...
      <p className="about-us-content">
        Join us in our mission to create a greener, healthier world. Visit Lilly & Rose
